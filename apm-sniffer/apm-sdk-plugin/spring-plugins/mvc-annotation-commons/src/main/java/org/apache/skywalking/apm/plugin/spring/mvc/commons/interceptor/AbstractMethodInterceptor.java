...
import vip.xiaxi.framework.xiaxi.boot.common.exception.XXApiForbiddenException;
import vip.xiaxi.framework.xiaxi.boot.common.exception.XXApiNotFoundException;
...
public abstract class AbstractMethodInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void handleMethodException(EnhancedInstance objInst, Method method, Object[] allArguments,
        ...
        if (t instanceof XXApiBadRequestException
                || t instanceof XXApiForbiddenException
                || t instanceof XXApiNotFoundException
        ) {
            //xiaxi sla define SpringMVC not a error,just log it
